              ...
              <div className="tour__content">
                ...
                <div className="tour__info">
                  ...
                  <div className="tour__extra-details">
                    ...
                    <span><i class="ri-money-dollar-circle-line" style={{color: "var(--secondary-color)"}}></i> ${price}/person</span>
                    <span><i class="ri-map-pin-time-line" style={{color: "var(--secondary-color)"}}></i> {distance} km</span>
                        ...
                        <div className="review__item">
                          ...
                          <div className="w-100">
                            <div className="d-flex align-items-center justify-content-between">
                              ...
                              {review.rating} <i class="ri-star-s-fill" style={{color: "var(--secondary-color)"}}></i> 
                              </span>
                            </div>
